...
Route::resource('users/auth/token', TokenGenerate::class, ['only' => ['store']]);
...
Route::resource('user.server', UserServerController::class, ['only' => ['index']]);
